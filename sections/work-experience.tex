...
% \cvsection{Work Experience}
\cveventSameLine{AI Engineer Intern}
...
\begin{itemize}
    ...
    \item Implemented video thumbnail \& upload components from design specs with unit tests; 
    Integrated backend APIs
    % Initiated meeting discussing moderation challenges
    % Initiated moderation/UI meeting
    % using Marko \& JavaScript,
    \item Initiated \& facilitated Content-Moderation/Development cross-team sync to set thumbnail-display gating
\end{itemize}
\dividerSmall
