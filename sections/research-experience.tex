...
\cveventSameLine{Skill Discovery for Coding Task Generation}
    {{\bodyfontsize \color{body} mentored by} \linked{Prof. Chao Zhang}{http://chaozhang.org}}
    {Sep 2025 -- Present}{\linked{Georgia Tech}{https://www.cc.gatech.edu}}{}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Innovated multi-turn preference dataset synthesis pipeline with fine-grained principles, cleaned up 100K samples with filtering heuristics
...
\begin{itemize}
    ...
    using <\$1 API cost \& <10 labeled samples while 20X faster; Wrote 40-page paper with detailed failure analysis; Released package for scalable data generation
\end{itemize}
\dividerSmall
...
\iftoggle{compact}{%
    ...
    \cveventSameLine{ECG Classification}%
        {{\bodyfontsize \color{body} mentored by} \linked{Dr. Mohammed Saeed}{https://www.uofmhealth.org/profile/4339/mohammed-saeed-md}}%
        {Sep 2021 -- Apr 2022}
        {\linked{UMich}{https://umich.edu}}{}%
    \begin{itemize}%
    ...
    \cveventSameLine{AR Art Museum Experience}%
        {{\bodyfontsize \color{body} mentored by} \linked{Prof. Kyungjin Yoo}{https://cmns.umd.edu/people/kyungjin-yoo}}%
        {Apr 2019 -- May 2020}
