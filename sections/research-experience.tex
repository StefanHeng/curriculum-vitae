...
\cveventSameLine{Strength-Controlled Preference Data Synthesis}
    {{\bodyfontsize \color{body} mentored by} \linked[0]{Prof. Chao Zhang}{http://chaozhang.org}}
...
\cveventSameLine{LLM as IE Data Generator}
    {{\bodyfontsize \color{body} mentored by} \linked[0]{Prof. Chao Zhang}{http://chaozhang.org}}
    {Sep 2023 -- Mar 2024}{\linked[0]{Georgia Tech}{https://www.cc.gatech.edu}}{}
\begin{itemize}
...
\iftoggle{compact}{%
    ...
    \cveventSameLine{Symbolic Music Generation}
        {{\bodyfontsize \color{body} mentored by} \linked[0]{Prof. Rada Mihalcea}{https://lit.eecs.umich.edu}}
        {Oct 2021 -- Feb 2023}
        {\linked[0]{UMich}{https://umich.edu}}{}
    \begin{itemize}
    ...
    \cveventSameLine{Personalized Text Classification Dataset}
        {{\bodyfontsize \color{body} mentored by} \linked[0]{Prof. Jason Mars}{https://www.jasonmars.org/2014/03/20/clarity-lab-at-university-of-michigan/}}
        {Jul 2022 -- Oct 2022}
        {\linked[0]{UMich}{https://umich.edu}}{}
    \begin{itemize}
    ...
    \cveventSameLine{AR Art Museum Experience}%
        ...
        {Apr 2019 -- May 2020}
        {\linked[0]{UMD}{https://www.fire.umd.edu}}{}%
    \begin{itemize}%
        % \item Mentored by
        %
