...
\iftoggle{compact}{%
  ...
  Scaled vLLM serving on enterprise GPUs (4X throughput; 20k+ Jira issues triaged via RAG/tool-use at Honeywell). 
  Trained a 100M domain LM with data synthesis and hallucination eval (-4X) at 22 Minds.
